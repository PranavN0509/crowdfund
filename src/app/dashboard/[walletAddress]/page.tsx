    ...
    return (
        <div className="mx-auto max-w-7xl px-4 mt-16 sm:px-6 lg:px-8">
            <div className="flex flex-row justify-between items-center mb-8">
                ...
                <button className="px-4 py-2 bg-blue-500 text-white rounded-md" onClick={() => setIsModalOpen(true)}
...
const CreateCampaignModal = (
    ...
    const handleCampaignImage = (value: string) => {
        if (value.length!==0) {
            ...
            <div className="w-1/2 bg-slate-100 p-6 rounded-md">
                ...
                <div className="flex flex-col">
                    ...
                    <input
                        type="file"
                        value={campaignImage}
                        onChange={(e) => handleCampaignImage((e.target.value))}
                        className="mb-4 px-4 py-2 bg-slate-300 rounded-md"
                    />
