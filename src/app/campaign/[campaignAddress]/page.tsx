...
export default function CampaignPage() {
    ...
    const { data: images, isLoading: isLoadingImages } = useReadContract({
        contract: contract,
        method: "function getCampaignImages() view returns ((string imglink)[])",
        params: [],
    });
    ...
    return (
        <>
            <div className="flex flex-col justify-between gap-y-5 mx-10 my-8">
                ...
                {!isLoadingBalance && (
                    <div className="w-full h-full">
                        ...
                        <div className="w-full h-6 bg-gray-200 rounded-full dark:bg-gray-700">
                            <div className="w-full h-6 bg-blue-600 rounded-full dark:bg-blue-500 text-right" style={{ width: `${balancePercentage?.toString()}%` }}>
                ...
                <Link href={`/campaign/${campaignAddress}/requests/`} className="p-0 m-0 flex-row justify-items-start">
                    <div className="flex-row justify-items-start">
                        <button className="bg-blue-600 px-4 py-2 rounded-md text-white font-semibold tracking-wide cursor-pointer">View Withdrawl Requests</button>
                    </div>
                </Link>

                <div>
                    <p className="text-lg font-semibold my-3">Tiers:</p>
                    <div className="grid grid-cols-3 gap-4">
                        {isLoadingTiers ? (
                            <p >Loading...</p>
                        ) : (
            ...
            <div className="m-4 bg-white p-8 rounded-md w-full">
                <div className=" flex items-center justify-between pb-6">
                    <div>
                        <h2 className="text-gray-600 font-semibold">Progress of Campaign</h2>
                        <span className="text-xs">Milestones achieved</span>
                    </div>
                    <div className="flex items-center justify-between">
                        <div className="lg:ml-40 ml-10 space-x-8">
                            <button className="bg-blue-600 px-4 py-2 rounded-md text-white font-semibold tracking-wide cursor-pointer">New Milestone</button>
...
const CreateCampaignModal = (
    ...
    return (
        ...
        <div className="w-full h-full fixed inset-0 bg-black bg-opacity-75 flex justify-center items-center backdrop-blur-md">
